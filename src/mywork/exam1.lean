...
----------------------------------
     [In English: Given propositions, P and Q, 
a derivation (computation) a proof of Q 
is derived by applying P → Q to P. 
       In logic: Applies a proof of P → Q, as a
kind of function, to any proof of P (argument) 
to derive a proof of Q.]
-/
...
-- By applying the true introduction rule to a statement,
we can simply assume that the statement is true. 
