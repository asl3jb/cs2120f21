...
--there exists a boolean b that is false. use false as a witness
begin
...
begin
  assume h,
  cases h with ball randg,
  apply exists.intro ball,
  exact and.elim_left randg,
end 
